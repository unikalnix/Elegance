  ...
  return (
    <>
      <div className="checkout__header">
        ...
        <div className="checkout__steps">
          ...
          <div className={`checkout__step ${step === 3 && 'checkout__step--active'}`}>
            <div className="checkout__step-number">{step === 1 || step === 2 ? '3' : '✓'}</div>
      ...
      <div className="checkout__content">
          ...
          <div className="checkout__summary-items">
            <div className="checkout__summary-item">
              <div className="checkout__summary-image">
                <img src="public\images\accessory.jpg" alt="Product" />
              </div>
            ...
            <div className="checkout__summary-item">
              <div className="checkout__summary-image">
                <img src="public\images\jeans.jpg" alt="Product" />
              </div>
              <div className="checkout__summary-details">
                <h3 className="checkout__summary-name">Premium Cotton Shirt</h3>
                <p className="checkout__summary-variant">White, Size M</p>
        ...
        {/* Shipping Details */}
     {
        step === 1 &&    <div className="checkout__form-container">
        ...
        <form className="checkout__form">
          ...
          <button onClick={(e) => {e.preventDefault();setStep(2)}} type="submit" className="checkout__submit-button">
            Continue to Payment
          </button>
        </form>
      </div>
        ...
        {/* Payment Details */}
       {
        step === 2 &&  <div className="checkout__form-container">
        ...
        <form className="checkout__form">
          ...
          <button onClick={(e) => {e.preventDefault();setStep(3)}} type="submit" className="checkout__submit-button">
            Pay 247.57 USD
          </button>
        </form>
      </div>
        ...
        {/* Confirmation */}
      {
        step === 3 &&   <div className="checkout__confirmation">
        ...
        <div className="checkout__confirmation-actions">
          <button onClick={() => navigate('/orders')} className="checkout__confirmation-button checkout__confirmation-button--primary">
            View Order Details
          </button>
          <button onClick={() => navigate('/shop')} className="checkout__confirmation-button checkout__confirmation-button--secondary">
            Continue Shopping
          </button>
        </div>
      </div>
